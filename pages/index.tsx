...
const MainPage: NextPage<DailyPuzzleProps> = ({ game }) => {
  ...
  return (
    <>
      <NavBar
        instructionClickHandler={instructionsElement.current?.showModal}
      ></NavBar>
      {/* <Navigation>
        <NavigationInner>
          <IconButton>
          ...
          <span> {gameName}</span>
          <IconButton onClick={(e) => instructionsElement.current?.showModal()}>
            <NavIcon
      ...
      <PageContainer>
        <InstructionModal ref={instructionsElement} />
